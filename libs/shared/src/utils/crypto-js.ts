// @ts-nocheck
import { useSiteConfigInfoState } from '@shared/store';
import { SM2Utils } from '@shared/utils';
import { pubkeyHex } from '@feature-chat/config';
/* eslint-disable */
export const CryptoJS = (function () {
  var t =
    t ||
    (function (t, r) {
      var e =
    ...
    (function () {
      ...
      s.HMAC = i.extend({
        init: function (t, r) {
          ...
          for (
            var n = (this._oKey = r.clone()), s = (this._iKey = r.clone()), a = n.words, c = s.words, h = 0;
            h < e;
            h++
          )
    ...
    (function () {
      var r = t,
        ...
        a = (o.EvpKDF = i.extend({
          ...
          compute: function (t, r) {
            for (
              var e = this.cfg, i = e.hasher.create(), o = n.create(), s = o.words, a = e.keySize, c = e.iterations;
              s.length < a;
      ...
      (function (r) {
        var e = t,
          ...
          _ = (p.Pkcs7 = {
            pad: function (t, r) {
              for (
                var e = 4 * r, i = e - (t.sigBytes % e), n = (i << 24) | (i << 16) | (i << 8) | i, s = [], a = 0;
                a < i;
                a += 4
              )
                s.push(n);
      ...
      var p = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
        _ = (n.AES = i.extend({
          _doReset: function () {
            if (!this._nRounds || this._keyPriorReset !== this._key) {
              ...
              for (var h = (this._invKeySchedule = []), l = 0; l < n; l++) {
                ...
                l < 4 || a <= 4
                  ? (h[l] = c)
                  : (h[l] = f[o[c >>> 24]] ^ u[o[(c >>> 16) & 255]] ^ d[o[(c >>> 8) & 255]] ^ v[o[255 & c]]);
              }
            }
          },
          ...
          _doCryptBlock: function (t, r, e, i, n, o, s, a) {
            ...
            var p =
                ((a[h >>> 24] << 24) | (a[(l >>> 16) & 255] << 16) | (a[(f >>> 8) & 255] << 8) | a[255 & u]) ^ e[d++],
